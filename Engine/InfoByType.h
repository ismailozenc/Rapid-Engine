...
static InfoByType NodeInfoByType[] = {
    ...
    {NODE_GET_VAR, 2, 2, 140, 100, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_VARIABLE}, {PIN_FLOW, PIN_ANY_VALUE}, {"Prev"}, {"Next", "Get value"}},
    {NODE_SET_VAR, 3, 2, 140, 130, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_VARIABLE, PIN_ANY_VALUE}, {PIN_FLOW, PIN_NONE}, {"Prev", "Set value"}, {"Next", ""}}, // shouldn't have PIN_NONE
