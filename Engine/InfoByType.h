...
static InfoByType NodeInfoByType[] = {
    ...
    {NODE_SET_VAR, 2, 1, 130, 100, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_ANY_VALUE}, {PIN_FLOW}, {"Prev", "Set value"}, {"Next"}},
    ...
    {NODE_CALL_CUSTOM_EVENT, 0, 1, 240, 200, {148, 0, 0, 200}, true, {PIN_FLOW}, {PIN_FLOW}, {"Prev"}, {"Next"}},
    {NODE_SPAWN_SPRITE, 1, 2, 240, 200, {20, 100, 20, 200}, true, {PIN_FLOW, PIN_SPRITE}, {PIN_FLOW}, {"Prev", "Sprite"}, {"Next"}},
    {NODE_DESTROY_SPRITE, 2, 1, 240, 200, {20, 100, 20, 200}, true, {PIN_FLOW, PIN_SPRITE}, {PIN_FLOW}, {"Prev", "Sprite"}, {"Next"}},
    {NODE_MOVE_TO_SPRITE, 3, 3, 240, 200, {20, 100, 20, 200}, true, {PIN_FLOW}, {PIN_FLOW}, {"Prev"}, {"Next"}},
    {NODE_BRANCH, 2, 2, 130, 100, {200, 170, 50, 200}, true, {PIN_FLOW, PIN_BOOL}, {PIN_FLOW, PIN_FLOW}, {"Prev", "Condition"}, {"True", "False"}},
