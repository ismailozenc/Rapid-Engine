...
static InfoByType NodeInfoByType[] = {
    ...
    {NODE_NUM, 2, 2, 120, 100, {80, 70, 110, 200}, true, {PIN_FLOW, PIN_NUM}, {PIN_FLOW, PIN_NUM}, {"Prev", "Set value"}, {"Next", "Get value"}},
    {NODE_STRING, 2, 2, 120, 100, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_STRING}, {PIN_FLOW, PIN_STRING}, {"Prev", "Set value"}, {"Next", "Get value"}},
    {NODE_BOOL, 2, 2, 120, 100, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_BOOL}, {PIN_FLOW, PIN_BOOL}, {"Prev", "Set value"}, {"Next", "Get value"}},
    {NODE_COLOR, 2, 2, 120, 100, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_COLOR}, {PIN_FLOW, PIN_COLOR}, {"Prev", "Set value"}, {"Next", "Get value"}},
    {NODE_SPRITE, 3, 3, 200, 180, {50, 140, 60, 200}, true, {PIN_FLOW, PIN_SPRITE}, {PIN_FLOW, PIN_SPRITE}, {"Prev", "Sprite"}, {"Next", "Sprite"}},
    {NODE_GET_VAR, 1, 2, 130, 100, {60, 100, 159, 200}, true, {PIN_FLOW}, {PIN_FLOW, PIN_ANY_VALUE}, {"Prev"}, {"Next", "Get value"}},
    {NODE_SET_VAR, 2, 2, 130, 100, {60, 100, 159, 200}, true, {PIN_FLOW, PIN_ANY_VALUE}, {PIN_FLOW, PIN_NONE}, {"Prev", "Set value"}, {"Next", ""}}, // shouldn't have PIN_NONE
    ...
    {NODE_SPAWN_SPRITE, 1, 2, 240, 200, {20, 100, 20, 200}, false, {PIN_FLOW, PIN_SPRITE}, {PIN_FLOW}, {"Prev", "Sprite"}, {"Next"}},
    {NODE_DESTROY_SPRITE, 2, 1, 240, 200, {20, 100, 20, 200}, false, {PIN_FLOW, PIN_SPRITE}, {PIN_FLOW}, {"Prev", "Sprite"}, {"Next"}},
    {NODE_MOVE_TO_SPRITE, 3, 3, 240, 200, {20, 100, 20, 200}, false, {PIN_FLOW}, {PIN_FLOW}, {"Prev"}, {"Next"}},
    {NODE_BRANCH, 2, 2, 130, 100, {200, 170, 50, 200}, false, {PIN_FLOW, PIN_BOOL}, {PIN_FLOW, PIN_FLOW}, {"Prev", "Condition"}, {"True", "False"}},
    {NODE_LOOP, 2, 2, 130, 100, {200, 170, 50, 200}, false, {PIN_FLOW, PIN_BOOL}, {PIN_FLOW, PIN_FLOW}, {"Prev", "Condition"}, {"Next", "Loop body"}},
    ...
    {NODE_PRINT, 2, 1, 140, 100, {90, 20, 120, 200}, false, {PIN_FLOW, PIN_ANY_VALUE}, {PIN_FLOW}, {"Prev", "Print value"}, {"Next"}},
    {NODE_DRAW_LINE, 6, 1, 240, 200, {90, 20, 120, 200}, false, {PIN_FLOW, PIN_NUM, PIN_NUM, PIN_NUM, PIN_NUM, PIN_COLOR}, {PIN_FLOW}, {"Prev", "Start X", "Start Y", "End X", "End Y", "Color"}, {"Next"}},
    {NODE_EX, 5, 5, 240, 200, {60, 100, 159, 200}, false, {PIN_FLOW, PIN_NUM, PIN_NUM, PIN_NUM, PIN_NUM}, {PIN_FLOW, PIN_FLOW, PIN_NUM, PIN_NUM, PIN_NUM}, {"Prev"}, {"Next"}},
...
{
    if (type < 0 || type >= typesCount) return -1;
